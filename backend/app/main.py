...
from app.api.v1 import calendar, career, evaluator, exams, focus_time, grades, history, job_agent, language_tutor, moodle_mock, planner, prompt, study_advisor, tutor, upload
